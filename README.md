...
```
--led-multiplexing=<0..5> : Multiplexing type: 0=direct; 1=strip; 2=checker; 3=spiral; 4=Z-strip; 5=coreman (Default: 0)
```
...
is no mapping ('standard' panels), while 1, 2, 3, 4 and 5 are different mappings
to try with. 
