...
try:
    ...
    while True:
        ...
        song_pos -= 1
        if song_pos + song_len <= 32:  # Reset when the end of text reaches the boundary at x=32
        ...
        artist_pos -= 1
        if artist_pos + artist_len <= 32:  # Reset when the end of text reaches the boundary at x=32
