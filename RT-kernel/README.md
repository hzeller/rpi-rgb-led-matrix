...
user / password
Then if you needto set up Wi-Fi, use the command - **nmtui**

Alternatively, set up a Wi-Fi hotspot on your phone using the details
Raspberry / password1
Then SSH from your phone to the connected Rasperry. Android will show the IP of the connected device to the Hotspot when clicking (i)
...
[raspberry_kernel_rt_trixie_120425_v2_boot.tar.gz](https://github.com/hzeller/rpi-rgb-led-matrix/blob/master/RT-kernel/raspberry_kernel_rt_trixie_120425_v2_boot.tar.gz)
[raspberry_kernel_rt_trixie_120425_v2_root.tar.gz](https://github.com/hzeller/rpi-rgb-led-matrix/blob/master/RT-kernel/raspberry_kernel_rt_trixie_120425_v2_root.tar.gz)
