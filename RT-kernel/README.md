...
**This precompiled kernel is for Raspberry Pi 4 64-bit. If you need anything different you will need to [compile your own](./spwm.md#RT-Kernel-Real-Time)**
 ...
 **Make defailt config, my example is Pi 4**
```
 ...
 **# 64-bit (ARCH=arm64)**
 Pi 3 / 3+ / CM3 / CM3+ / Zero 2 W / Pi 4 / Pi 400 / CM4 / CM4S
`bcm2711_defconfig`
 Pi 5 / Pi 500 / CM5
`bcm2712_defconfig`

 **# 32-bit (ARCH=arm)**
 Pi 1 / CM1 / Zero / Zero W / Pi 2
`bcmrpi_defconfig`
 Pi 3 / 3+ / CM3 / CM3+ / Zero 2 W
`bcm2709_defconfig`
