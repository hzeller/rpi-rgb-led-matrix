...
// Draw a circle centered at "x", "y", with a radius of "radius" and with "color"
void DrawCircleFill(Canvas *c, int x, int y, int radius, const Color &color);
void DrawFastVLine(Canvas *c, int x, int y, int radius, const Color &color);
void FillCircleHelper(Canvas *c, int x, int y, int radius, int cornername, int delta, const Color &color);
